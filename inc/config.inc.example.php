...
if ( 1 == LANGUAGE_MANAGER ) {
    ...
    if ( USE_SANDBOX == true ) {
        ...
        if ( "ITA" == FORM_LANG ) {
            ...
            $url_di_base = "https://work.almagioni.it"; // Sviluppo ITA
        } elseif ( "ENG" == FORM_LANG ) {
            define( "PERCORSO_DI_BASE", "/var/www/" ); // Sviluppo ENG
            $url_di_base = "https://work.almagioni.it/en"; // Sviluppo ENG
        } else { //Default
            define( "PERCORSO_DI_BASE", "/var/www/" ); // Sviluppo lingua di default
            $url_di_base = "https://work.almagioni.it/en"; // Sviluppo lingua di default
        }
    } else {
